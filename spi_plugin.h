...
//-----------------------------------------------------------------------------
int __declspec(dllexport) WINAPI GetArchiveInfo(
	LPSTR buf,					// flagがファイルの場合、ファイル名
								// flagがメモリの場合、ファイルイメージポインタ
	long len,					// flagがファイルの場合、読み込み開始オフセット
								// flagがメモリの場合、データサイズ
...
//-----------------------------------------------------------------------------
int __declspec(dllexport) WINAPI GetFileInfo(
	LPSTR buf,					// flagがファイルの場合、ファイル名
								// flagがメモリの場合、ファイルイメージポインタ
	long len,					// flagがファイルの場合、読み込み開始オフセット
								// flagがメモリの場合、データサイズ
...
//-----------------------------------------------------------------------------
int __declspec(dllexport) WINAPI GetFile(
	LPSTR src,					// flagがファイルの場合、ファイル名
								// flagがメモリの場合、ファイルイメージポインタ
	long len,					// flagがファイルの場合、読み込み開始オフセット
								// flagがメモリの場合、データサイズ
